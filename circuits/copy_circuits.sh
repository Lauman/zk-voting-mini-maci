...
declare -A FILES_TO_COPY=(
    ...
    ["vote_circuit_0001.zkey"]="${ROOTPATH}frontend/public/zk/vote_circuit_final.zkey"
    ["vote_circuit_js/vote_circuit.wasm"]="${ROOTPATH}frontend/public/zk/vote_circuit.wasm"
